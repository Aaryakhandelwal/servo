...
pub fn throw_dom_exception(cx: SafeJSContext, global: &GlobalScope, result: Error) {
    ...
    let code = match result {
        Error::IndexSize => DOMErrorName::IndexSize,
        Error::NotFound => DOMErrorName::NotFound,
        Error::HierarchyRequest => DOMErrorName::HierarchyRequest,
        Error::WrongDocument => DOMErrorName::WrongDocument,
        Error::InvalidCharacter => DOMErrorName::InvalidCharacter,
        Error::NotSupported => DOMErrorName::NotSupported,
        Error::InUseAttribute => DOMErrorName::InUseAttribute,
        Error::InvalidState => DOMErrorName::InvalidState,
        Error::Syntax => DOMErrorName::Syntax,
        Error::Namespace => DOMErrorName::Namespace,
        Error::InvalidAccess => DOMErrorName::InvalidAccess,
        Error::Security => DOMErrorName::Security,
        Error::Network => DOMErrorName::Network,
        Error::Abort => DOMErrorName::Abort,
        Error::Timeout => DOMErrorName::Timeout,
        Error::InvalidNodeType => DOMErrorName::InvalidNodeType,
        Error::DataClone => DOMErrorName::DataClone,
        Error::NoModificationAllowed => DOMErrorName::NoModificationAllowed,
        Error::QuotaExceeded => DOMErrorName::QuotaExceeded,
        Error::TypeMismatch => DOMErrorName::TypeMismatch,
        Error::InvalidModification => DOMErrorName::InvalidModification,
        Error::NotReadable => DOMErrorName::NotReadable,
        Error::Operation => DOMErrorName::Operation,
